...
<!-- Mirrored from demo.deviserweb.com/cv/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Feb 2017 04:52:22 GMT -->
<head>
        <meta charset="utf-8">
        
        <!-- TITLE OF SITE-->
        <title> CV Apply For PHP Position </title>
                    ...
                    <div class="row">                      
                        ...
                        <div class="heading">                            
                            ...
                            <div class="feature-img">
                                <a href="index.php?page=page/home"><img src="assets/images/profile-img.jpg" class="responsive-img" alt=""></a> 
                            </div>                            
                            <!-- =========================================
                                       NAVIGATION   
                            ==========================================-->
                                ...
                                <nav>
                                    <div class="nav-wrapper">
                                      <ul id="nav-mobile" class="side-nav">                                  
                                        <li><a href="index.php?page=page/home">Resume</a></li>
                                        <li><a href="index.php?page=page/cover-letter">Cover Letter</a></li>
                                      </ul>
                            ...
                            <div class="title col s12 m12 l9 right  wow fadeIn" data-wow-delay="0.1s">   
                                <h2>Ôn Thái Hưng</h2> <!-- title name -->
                                <span>Programmer</span>  <!-- tagline -->
                            </div>                         
                        </div>
                         <!-- sidebar info -->
                            ...
                            <div class="row">                               
                                ...
                                <div class="col m12 s12 l9 info wow fadeIn a1" data-wow-delay="0.1s" > <!-- text -->
                                    <div class="section-item-details">
                                        <p style="text-align: justify;">My name's Hung. I'm a student. My major is Information Technology. Especially, I like working on programming website. My target is create a UI/UX website.</p>
                                    </div>             
                                </div>
                            </div>         
                        </div>
                        ...
                        <div class="col l12 m12 s12  mobile sidebar-item">
                            <div class="row">                                
                                ...
                                <div class="col m12 s12 l9 info wow fadeIn a2" data-wow-delay="0.2s" >
                                    <div class="section-item-details">
                                        <div class="personal">
                                            <h4><a href="tel:555-555-5555">01658-757-926</a></h4> <!-- Number -->             
                                            <span>mobile</span> 
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col l12 m12 s12  email sidebar-item ">
                            <div class="row">                                
                                ...
                                <div class="col m12 s12 l9 info wow fadeIn a3" data-wow-delay="0.3s">
                                    <div class="section-item-details">
                                        <div class="personal">                                    
                                            <h4><a href="mailto:thaihung019@gmail.com">thaihung019@gmail.com</a></h4> <!-- Email -->
                                            <span>personal</span> 
                                        </div>
                                        <div class="work">                                 
                                            <h4><a href="mailto:pay4listen@gmail.com">pay4listen@gmail.com</a></h4> <!-- Email -->
                                            <span>work</span> <br>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="col m12 s12 l9 info wow fadeIn a4" data-wow-delay="0.4s">
                                    <div class="section-item-details">
                                        <div class="address-details"> <!-- address  -->
                                            <h4>140/6 Lê Đức Thọ, p6<br>
                                            Q.Gò Vấp, Tp. Hồ Chí Minh.<br>
                                            </h4> 
                                        </div>                         
                                    </div>
                                </div>
...
<!-- Mirrored from demo.deviserweb.com/cv/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Feb 2017 04:52:36 GMT -->
</html>
